...
import { CompleteHost, HostModel, CompleteUser, UserModel, CompleteProfile, ProfileModel, CompleteTeam, TeamModel, CompleteHashedLink, HashedLinkModel, CompleteBooking, BookingModel, CompleteAvailability, AvailabilityModel, CompleteWebhook, WebhookModel, CompleteDestinationCalendar, DestinationCalendarModel, CompleteEventTypeCustomInput, EventTypeCustomInputModel, CompleteSchedule, ScheduleModel, CompleteWorkflowsOnEventTypes, WorkflowsOnEventTypesModel, CompleteAIPhoneCallConfiguration, AIPhoneCallConfigurationModel, CompleteEventTypeTranslation, EventTypeTranslationModel, CompleteSelectedCalendar, SelectedCalendarModel, CompleteCalVideoSettings, CalVideoSettingsModel, CompleteSecondaryEmail, SecondaryEmailModel } from "./index"
...
export const _EventTypeModel = z.object({
  ...
  interfaceLanguage: z.string().nullish(),
  ...
  allowReschedulingCancelledBookings: z.boolean().nullish(),
  price: z.number().int(),
  currency: z.string(),
  ...
  maxActiveBookingsPerBooker: z.number().int().nullish(),
  maxActiveBookingPerBookerOfferReschedule: z.boolean(),
  customReplyToEmail: imports.emailSchema.nullish(),
  ...
  restrictionScheduleId: z.number().int().nullish(),
})
...
export const EventTypeModel: z.ZodSchema<CompleteEventType> = z.lazy(() => _EventTypeModel.extend({
  ...
  calVideoSettings: CalVideoSettingsModel.nullish(),
  secondaryEmail: SecondaryEmailModel.nullish(),
  restrictionSchedule: ScheduleModel.nullish(),
}))
